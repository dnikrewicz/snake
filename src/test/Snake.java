...
public class Snake {
    ...
    /**
     * konstruktor bez parametrowy weza
     */
    public Snake() {
        body = new ArrayList<>();
    ...
    /**
     * funkcja odpowiedzialna za ruch weza
     */
    public void move() {
        if(move != "NOTHING") {
    ...
    /**
     * funkcja odpowiedzialna za powiekszanie weza,
     * uzywana w przypadku zderzenia weza z jablkiem
     */
    public void grow() {
        Rectangle first = body.get(0);
